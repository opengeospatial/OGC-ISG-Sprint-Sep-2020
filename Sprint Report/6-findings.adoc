...
NOTE: "Uniform Resource Identifier (URI): Generic Syntax" site:[RFC3986] specifies that the colon (":") is a reserved character and needs to be URL-encoded.
...
* _Helyx, also mentioned by 1 or 2 others_

==== Request attributes

* _Helyx - alternate distributions, especially with different content types_
