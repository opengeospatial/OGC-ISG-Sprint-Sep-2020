...
[#Ecere-3d-tiles-generation,reftext='{figure-caption} {counter:figure-num}']
...
[#Ecere-API-BuildingModelTile,reftext='{figure-caption} {counter:figure-num}']
...
[#Ecere-API-BridgeModel,reftext='{figure-caption} {counter:figure-num}']
...
[#Ecere-Removed,reftext='{figure-caption} {counter:figure-num}']
