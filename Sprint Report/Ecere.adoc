...
San Diego CDB Coronado bridge layer: https://maps.ecere.com/ogcapi/collections/SanDiegoCDB:CoronadoBridge
...
.San Diego CDB hydrography data layer
...
.San Diego CDB roads data layer
image::images/Ecere/roads.jpg[align="center",width="800"]
...
image::images/Ecere/imagery7.jpg[align="center",width="800"]
...
These tilesets work can be used directly with clients based on CesiumJS, or other clients supporting 3D Tiles.
...
_OGC - Testbed 14 - CityGML and Augmented Reality_ work package, tested with a detailed CDB of New York City from Flight Safety, and detailed in the
...
to a tile matrix set defined by the 2DTiled Matrix Set standard:
...
Example Buildings 3D Model (E3D): https://maps.ecere.com/ogcapi/collections/SanDiegoCDB:Buildings/models/1476625110.e3d

Example Buildings 3D Model (glTF): https://maps.ecere.com/ogcapi/collections/SanDiegoCDB:Buildings/models/1476625110.glb

[#Ecere-API-BuildingModel,reftext='{figure-caption} {counter:figure-num}']
.glTF 3D building visualized in https://gltf-viewer.donmccurdy.com/#model=https://maps.ecere.com/ogcapi/collections/SanDiegoCDB:Buildings/models/1476625110.glb[glTF model viewer]
...
Ecere proposed that a straightforward way to support updates of 3D models would be t osupport the _Simple Transactions_ extension originally defined for _OGC API - Features_.
...
For the ISG sprint, Ecere spent efforts mainly spent on improving the server component and investigating a mechanism to update the 3D data.
